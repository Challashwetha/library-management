...
public class LibraryManagementSystem {
    ...
    // Illustrating Application CLass To Create The Menu For the Program
...
// Illustrating book Class that takes Input from the books and related information
...
class book {
    ...
    public book() {
        ...
        // taking input via nextInt() and nextLine() standard methods
...
// Illustrating books class To Do all the Operations related to Books such as add, check-in, check-out,Valid books,Update books
...
//Illustrating Student Class to take Input from the student and related Information
...
//Illustrating students Class To Do all the Operations related to students:
